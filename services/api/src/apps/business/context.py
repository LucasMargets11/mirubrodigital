...
from apps.business.features import feature_flags_for_plan, feature_flags_for_subscription
...
def build_business_context(business) -> Dict[str, object]:
  ...
  # Usar feature_flags_for_subscription para incluir lógica de addons
  feature_flags = feature_flags_for_subscription(subscription)
