...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("accounts", "0032_alter_accessauditlog_action"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    (
                        "ADMIN_QR_REVIEWS_CONFIG_UPDATED",
                        "Admin QR Reviews Config Updated",
                    ),
                    ("ADMIN_SUBSCRIPTION_VIEWED", "Admin Subscription Viewed"),
                    ("ADMIN_SUBSCRIPTION_CANCELED", "Admin Subscription Canceled"),
                    (
                        "ADMIN_COMPLIMENTARY_ACCESS_GRANTED",
                        "Admin Complimentary Access Granted",
                    ),
