# Generated manually — adds origin field to SupportTicket + tenant audit actions
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0023_add_contador_role'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[('admin', 'Creado por admin'), ('tenant', 'Creado por tenant')],
                db_index=True,
                default='admin',
