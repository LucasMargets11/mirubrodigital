...
interface OnlineMenuSettingsClientProps {
    canUploadImages: boolean;
}

export function OnlineMenuSettingsClient({ canUploadImages }: OnlineMenuSettingsClientProps) {
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
           <div className="bg-white p-4 rounded-lg border shadow-sm space-y-3">
              <h2 className="text-lg font-semibold">QR y enlaces</h2>
              <p className="text-sm text-slate-500">
                Generá, descargá y compartí el código QR de tu carta desde la página dedicada.
              </p>
              <Link
                href="/app/carta/publicacion"
                className="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-blue-300 hover:bg-blue-50"
              >
                📱 Gestionar QR y enlaces →
              </Link>
           </div>
        </div>
      </div>
