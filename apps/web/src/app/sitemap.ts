...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    const staticRoutes: MetadataRoute.Sitemap = [
        ...
        { url: `${SITE_URL}/gestion`, changeFrequency: 'monthly', priority: 0.7 },
        { url: `${SITE_URL}/carta`, changeFrequency: 'monthly', priority: 0.7 },
        { url: `${SITE_URL}/resenas`, changeFrequency: 'monthly', priority: 0.7 },
