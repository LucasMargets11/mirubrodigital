...
import type { GcSubscribeConfig } from '@/features/billing/components/GestionComercialPlanBuilder';
import type { MenuQrSubscribeConfig } from '@/features/billing/components/MenuQrPlanBuilder';
import type { QrProState } from '@/features/billing/components/MenuQrComparisonTable';
import type { QrReviewsSubscribeConfig } from '@/features/billing/components/QrReviewsPlanBuilder';
import type { ProModule } from '@/features/billing/data/menu-qr-catalog';
import type { BillingVertical, Bundle } from '@/features/billing/types';
import { useRouter, useSearchParams } from 'next/navigation';
import { QrCode, Store, Star, type LucideIcon } from 'lucide-react';
import { cn } from '@/lib/utils';

// ── Lazy-loaded billing builders (code-split per vertical) ───────────────────

const GestionComercialPlanBuilder = dynamic(() =>
    import('@/features/billing/components/GestionComercialPlanBuilder').then(m => ({ default: m.GestionComercialPlanBuilder }))
);
const GestionComercialComparisonTable = dynamic(() =>
    import('@/features/billing/components/GestionComercialComparisonTable').then(m => ({ default: m.GestionComercialComparisonTable }))
);
const MenuQrPlanBuilder = dynamic(() =>
    import('@/features/billing/components/MenuQrPlanBuilder').then(m => ({ default: m.MenuQrPlanBuilder }))
);
const MenuQrComparisonTable = dynamic(() =>
    import('@/features/billing/components/MenuQrComparisonTable').then(m => ({ default: m.MenuQrComparisonTable }))
);
const QrReviewsPlanBuilder = dynamic(() =>
    import('@/features/billing/components/QrReviewsPlanBuilder').then(m => ({ default: m.QrReviewsPlanBuilder }))
);
const PlansBundles = dynamic(() =>
    import('@/features/billing/components/PlansBundles').then(m => ({ default: m.PlansBundles }))
);
const PlansBuilderWizard = dynamic(() =>
    import('@/features/billing/components/PlansBuilderWizard').then(m => ({ default: m.PlansBuilderWizard }))
);
const CommercialPlanBuilder = dynamic(() =>
    import('@/features/billing/components/CommercialPlanBuilder').then(m => ({ default: m.CommercialPlanBuilder }))
);
